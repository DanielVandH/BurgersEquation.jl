...
text!(fig.content[end], [-10.0], [25.0]; text=L"s_0^{(1)}", fontsize=48, color=:black)
...
text!(fig.content[end], [-30.0], [10.0]; text=L"s_0^{(1)}", fontsize=48, color=:black)
...
text!(fig.content[end], [-10.0], [20.0]; text=L"s_0^{(1)}", fontsize=48, color=:black)
...
text!(fig.content[end], [10.0], [40.0]; text=L"s_0^{(1)}", fontsize=48, color=:black)
