...
const X_AAA = parse.(Float64, readdlm("paper/data/X_AAA.dat"))
const Y_AAA = parse.(Float64, readdlm("paper/data/Y_AAA.dat"))
const T_AAA = parse.(Float64, readdlm("paper/data/T_AAA.dat"))
const μ_AAA = readdlm("paper/data/mu_AAA.dat")[1]

# The constants below are obtained in the MATLAB script "burger_tracking_poles.m".
const T_AAA_POLES = parse.(Float64, readdlm("paper/data/T_AAA_POLES.dat"))
