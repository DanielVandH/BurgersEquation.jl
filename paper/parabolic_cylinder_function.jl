x = [collect(-6.0:0.01:6.0), collect(-6.0:0.01:6.0), collect(-6.0:0.01:6.0), ArbReal.(-6:0.07:6, bits=1024)]
y = [collect(-6.0:0.01:6.0), collect(-6.0:0.01:6.0), collect(-6.0:0.01:6.0), ArbReal.(-6:0.07:6, bits=1024)]
μ = [2.0, 1.0, 0.5, ArbReal(0.1, bits=1024)]
Φ₀_vals = Φ₀.(x, y, μ)
t = 1e-6
