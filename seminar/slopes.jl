...
xlims!(ax, 0, 5.0)
ylims!(ax, 0, 3.5)
text!(ax, L"\mu = 0.0", position=(1.02, 1.3), rotation=1.0, color=:black, fontsize=36.4)
text!(ax, L"\mu = 0.05", position=(3.0, 1.3), rotation=0.0, color=:black, fontsize=36.4)
text!(ax, L"\mu = 0.1", position=(2.2, 0.7), rotation=-0.05, color=:black, fontsize=36.4)
text!(ax, L"\mu = 1.0", position=(1.5, 0.17), rotation=0.0, color=:black, fontsize=36.4)
